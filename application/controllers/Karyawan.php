...
class Karyawan extends CI_Controller{
    ...
    function tambah_aksi() {
        ...
        $this->M_karyawan->input_data($data,'table_12210510');
    ...
    function edit ($id) {
        $where = array('id' => $id);
        $data['karyawan'] = $this->M_karyawan->edit_data($where,'table_12210510')->result();
        $data['status'] = ['Menikah','Belum Menikah'];
        $data['jabatan'] = ['Manager','Direktur','Staff'];
    ...
    function update() {
        ...
        $this->M_karyawan->update_data($where,$data,'table_12210510');
        redirect('karyawan/index');
    } 

    function hapus ($id) {
        $where = array('id' => $id);
        $this->M_karyawan->hapus_data($where,'table_12210510');
        redirect('karyawan/index');
    }
}